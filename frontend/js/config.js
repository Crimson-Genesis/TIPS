// ═══════════════════════════════════════════════════════════════
// TIPS Unified Frontend — config.js
// Shared constants, file map, chart defaults
// ═══════════════════════════════════════════════════════════════

export const CONFIG = {
    // When served from the backend API (web_ui/server.py)
    API_BASE: '/api/output',
    // Relative path when opened as a static file (fallback)
