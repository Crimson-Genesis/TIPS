...
% Abstract - first page, no page number
\thispagestyle{empty}
\vspace*{\fill}
\begin{center}
...
TIPS also includes a fully implemented Interview Recording UI for capturing video interviews using WebRTC technology, and a comprehensive Dashboard for visualizing analysis results. This report documents the complete design and implementation of the TIPS system, including the backend pipeline, the Interview Recording UI, and the Dashboard visualization system.
\vspace*{\fill}
